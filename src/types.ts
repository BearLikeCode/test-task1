 ...
 * type of your own.
 */
export type BankAccountEventBase = IAccountOpenedEventBase | IMoneyDebitedEventBase | IMoneyCreditedEventBase

export interface IAccountOpenedEventBase {
  accountId: string
  type: 'AccountOpened'
  ownerName: string
  time: string
...
export interface IMoneyDebitedEventBase {
  type: 'MoneyDebited'
  value: number
}

export  interface IMoneyCreditedEventBase {
  type: 'MoneyCredited'
  value: number
}
...
export interface IBankAccountUserFile {
  type: string,
  ownerName: string,
  accountId: string
  position: number
